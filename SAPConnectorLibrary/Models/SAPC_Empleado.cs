...
public partial class SAPC_Empleado
{
    ...
    public SAPC_Empleado()
    {
        ...
        this.FacturasProveedor = new HashSet<SAPC_Rendicion>();

        this.RendicionesABC = new HashSet<SAPC_Rendicion>();
    ...
    public virtual ICollection<SAPC_Rendicion> FacturasProveedor { get; set; }

    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]

    public virtual ICollection<SAPC_Rendicion> RendicionesABC { get; set; }
