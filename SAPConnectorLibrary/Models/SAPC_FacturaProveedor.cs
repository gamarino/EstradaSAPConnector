...
public partial class SAPC_FacturaProveedor
{
    ...
    public SAPC_FacturaProveedor()
    {
        ...
        this.Inputaciones = new HashSet<SAPC_InputacionesFacturas>();
    ...
    public virtual ICollection<SAPC_InputacionesFacturas> Inputaciones { get; set; }
    ...
    public virtual SAPC_Empleado SAPC_Empleado { get; set; }
